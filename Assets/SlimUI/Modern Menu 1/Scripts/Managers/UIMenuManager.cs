...
namespace SlimUI.ModernMenu
{
	public class UIMenuManager : MonoBehaviour
	{
		...
		[Tooltip("Optional 4th Menu")]
		public GameObject topRunnersMenu;
		...
		void Start()
		{
			...
			if (topRunnersMenu) topRunnersMenu.SetActive(false);
		...
		public void ShopMenu()
		{
			...
			topRunnersMenu.SetActive(false);
			exitMenu.SetActive(false);
			dropShip.SetActive(false);
		}

		public void TopRunnersMenu()
		{
			playMenu.SetActive(false);
			if (topRunnersMenu) topRunnersMenu.SetActive(true);
